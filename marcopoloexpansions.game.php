...
class MarcoPoloExpansions extends Table
{
    ...
    */
    ...
    function getAltanOrdResourcesForTradingPost(int $number_of_trading_posts): array
    {
        $resources = [];
    ...
    function scoreAltanOrdPlacement($board_id, $player_id, $num_trading_posts)
    {
        ...
        self::incStat(1, "trading_post_points", $player_id);
    }

    function scoreTradePostPlacement($board_id, $player_id, $num_trading_posts)
    {
        $num_vp = 0;
    ...
    */
    ...
    function checkPersonalCityCard27($player_id)
    {
        ...
        if (str_replace("city_card_", "", $pending_actions[0]["location"]) == 27 && $pending_actions[0]["remaining_count"] == 1)
    ...
    */
    ...
    function stGameRollAllDice()
    {
        ...
        $dice = self::getCollectionFromDB("SELECT die_id, die_type, die_player_id, die_location, die_location_arg, die_location_height, die_value FROM die WHERE (die_type <> 'fixed')");
        $rolled_dice = [];
